       ...
       <table style="background-color:black; color:white;">
           ...
           @foreach ($appoint as $appoint)
                <tr style="background-color:black;" align="center">
                            ...
                            <td>
                                <a class="bt btn-danger" onclick="return confirm('are you sure to cancel this appoointment')" 
                                href="{{url('cancel_appoint',$appoint->id)}}">cancel</a>
                            </td>
                       
                </tr>
           @endforeach
           <!-- onclick=...delete arart message -->
